			...
			<View style={styles.container}>
				...
				<View style={{ flex: 10, minHeight: 500 }}>
					<FlatList
						...
						renderItem={(element) => {
							return (
								<FotoItem onLongClick={this._photoLongPress} clickFun={this.photoClick} uri={element.item.uri} numColumns={this.state.numColumns} id={element.item.id} clicked={element.item.clicked} size={`${element.item.width}x${element.item.height}`} />
							)
						}}
